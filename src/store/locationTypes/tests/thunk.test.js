...
describe("store/locationTypes/actions", () => {
  ...
  it("should fetch a single locationType from server", async () => {
    LocationTypeService.getLocationType.mockReturnValueOnce(
      fixtures.singleLocationType
    );
  ...
  it("should create a locationType", async () => {
    LocationTypeService.createLocationType.mockReturnValueOnce(
      fixtures.singleLocationType
    );
  ...
  it("should edit a locationType", async () => {
    LocationTypeService.editLocationType.mockReturnValueOnce(
      fixtures.singleLocationType
    );
