...
export const pageLinks = locationData.links;
export const totalPages = locationData.meta.pagination.pages;
export const currentPage = locationData.meta.pagination.page;
